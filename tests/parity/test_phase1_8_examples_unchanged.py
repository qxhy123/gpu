"""Smoke-test: each Phase 1-8 example runs without crashing on Phase 8 Device path."""
import pytest
...
@pytest.mark.parametrize("ex", [e for e in PHASE_1_8_EXAMPLES if e not in SLOW_EXAMPLES])
def test_phase_1_8_example_smoke(ex):
...
def test_phase_1_8_example_smoke_slow(ex):
