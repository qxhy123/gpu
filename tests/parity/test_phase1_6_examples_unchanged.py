"""Smoke-test: each Phase 1-6 example runs without crashing on Phase 6 Device path."""
import pytest
...
@pytest.mark.parametrize("ex", [e for e in PHASE_1_6_EXAMPLES if e not in SLOW_EXAMPLES])
def test_phase_1_6_example_smoke(ex):
...
def test_phase_1_6_example_smoke_slow(ex):
